...
void setTimerRegisters(TcCount8* TC, int frequencyHz);
void TC3_Handler();
bool isBlueOn = false;
...
void startTimer(int frequencyHz) {
  ...
  // Possible solution: Set CCx to what the blue led needs and increment a variable when the Handler runs
  // Flip blue for every handler run
  // If the variable is even flip yellow
